...
import (
	...
	"github.com/valkyrie-fnd/valkyrie/application/provider/redtiger"

	"github.com/valkyrie-fnd/valkyrie/application/internal/testutils"
	pamtestutils "github.com/valkyrie-fnd/valkyrie/pam/testutils"
)
...
func toMoney(val float64) redtiger.Money {
	return redtiger.Money(pamtestutils.NewFloatAmount(val))
}

func toJackpotMoney(val float64) redtiger.JackpotMoney {
	return redtiger.JackpotMoney(pamtestutils.NewFloatAmount(val))
}
