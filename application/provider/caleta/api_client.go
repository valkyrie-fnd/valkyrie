...
type apiClient struct {
	rest         httpclient.HTTPClientJSONInterface
...
func NewAPIClient(client httpclient.HTTPClientJSONInterface, config configs.ProviderConf) (*apiClient, error) {
...
func (apiClient *apiClient) requestGameLaunch(ctx context.Context, body GameUrlBody) (*InlineResponse200, error) {
	...
	if err != nil {
		...
		return nil, httpclient.NewHTTPError(fiber.StatusInternalServerError, "Failed to sign request")
	}
