...
type mockRestClient struct {
	httpclient.HTTPClientJSONInterface
	JSONFunc func(ctx context.Context, req *httpclient.HTTPRequest, resp any) error
}

func (m mockRestClient) PostJSON(ctx context.Context, req *httpclient.HTTPRequest, resp any) error {
	return m.JSONFunc(ctx, req, resp)
}

func (m mockRestClient) GetJSON(ctx context.Context, req *httpclient.HTTPRequest, resp any) error {
	return m.JSONFunc(ctx, req, resp)
}
...
func Test_requestGameLaunch(t *testing.T) {
	type tests struct {
		name   string
		body   GameUrlBody
		jsonFn func(_ context.Context, req *httpclient.HTTPRequest, resp any) error
	...
	var gameLaunchTests = []tests{
		...
		},
		{
			...
			jsonFn: func(_ context.Context, _ *httpclient.HTTPRequest, _ any) error {
		...
		},
		{
			...
			jsonFn: func(_ context.Context, _ *httpclient.HTTPRequest, resp any) error {
				reflect.ValueOf(resp).
					Elem().
	...
	var gameRenderTests = []tests{
		{
			...
			gameRoundID: "909",
			jsonFn: func(ctx context.Context, req *httpclient.HTTPRequest, resp any) error {
		...
		{
			name:        "get game render page httpclient error",
			gameRoundID: "909",
			jsonFn: func(ctx context.Context, req *httpclient.HTTPRequest, resp any) error {
