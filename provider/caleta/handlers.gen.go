...
func (siw *ServerInterfaceWrapper) Walletbalance(c *fiber.Ctx) error {
	...
	if value, found := headers[http.CanonicalHeaderKey("X-Auth-Signature")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Auth-Signature", value, &XAuthSignature, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: true})
		if err != nil {
...
func (siw *ServerInterfaceWrapper) Walletbet(c *fiber.Ctx) error {
	...
	if value, found := headers[http.CanonicalHeaderKey("X-Msg-Timestamp")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-Msg-Timestamp", value, &XMsgTimestamp, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false})
		if err != nil {
